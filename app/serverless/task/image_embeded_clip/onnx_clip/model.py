...
def get_similarity_scores(
    ...
    `get_similarity_scores(image_embeddings)`.
...
class OnnxClip:
    ...
    def __init__(
        ...
        Args:
            ...
            batch_size: If set, splits the lists in `get_image_embeddings`
                into batches of this size before
        ...
        self.image_model = self._load_models(model, silent_download, cache_dir=cache_dir)
    ...
    def _load_models(
        ...
        path = os.path.join(cache_dir, IMAGE_MODEL_FILE)

        return OnnxClip._load_model(path, silent)
